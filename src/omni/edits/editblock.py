...
class EditBlockParser:
    ...
    async def parse(self, text: str, file_path: str | None = None) -> list[Edit]:
        """
    ...
    def _parse_generic_blocks(self, text: str, default_file: str | None) -> list[Edit]:
    ...
    def _parse_whole_file_blocks(self, text: str, default_file: str | None) -> list[Edit]:
        """
    ...
    def _extract_context(self, search_text: str) -> str | None:
        """
