...
class GitRepository:
    ...
    def __init__(
        ...
        # State tracking
        self._last_commit_before_edit: str | None = None
    ...
    async def commit_dirty_changes(self, message: str | None = None) -> str | None:
        """
    ...
    async def dirty_commit(self) -> str | None:
    ...
    async def commit(
        ...
        if ai_attributed:
            cmd.extend(["--trailer", "AI-generated-by: Omni-LLM"])
    ...
    async def create_worktree(self, path: str, branch: str | None = None) -> bool:
        """
    ...
    async def merge_branch(self, source_branch: str, target_branch: str | None = None) -> bool:
        """
    ...
    async def get_diff(self, file_path: str | None = None) -> str:
        """
        Get diff of changes.
