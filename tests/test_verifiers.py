...
from omni.core.verifier import Verifier, VerificationResult, VerificationPipeline, NoOpVerifier
from omni.core.verifiers import TestVerifier, LintVerifier
...
class TestTestVerifier:
    ...
    def test_initialization(self):
        ...
        assert verifier.coverage == True
        assert verifier.junit_report == True
        assert verifier.enabled == True
    ...
    def test_default_initialization(self):
        ...
        assert verifier.coverage == False
        assert verifier.junit_report == True
...
""")
        ...
        assert result.passed == False or result.details.get("exit_code") == 1
